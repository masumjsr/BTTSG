...
import com.mssoftinc.bttsg.ui.viewmodel.HistoryCategoryViewModel

@Composable
fun HistoryCategoryScreenRoute(
    onBackClick: () -> Unit,
    viewModel: HistoryCategoryViewModel = hiltViewModel(),
    onItemClick: (String, Long) -> Unit,
) {
    val title = "History"
    val category by viewModel.category.collectAsStateWithLifecycle()
    HistoryCategoryScreen(onBackClick = onBackClick, title = title, category = category,onItemClick=onItemClick)
}
...
@Preview
@Composable
fun PreviewHistoryCategoryScreen() {
    CategoryScreen(
        onBackClick = {},
